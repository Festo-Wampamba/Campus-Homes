...
export default async function StaffAccountsPage() {
  ...
  return <><PageHeader eyebrow="Access control" title="Staff accounts" description="Invite internal users and review every active fine-grained role assignment and scope." actions={<><Link href="/admin/users" className={buttonVariants({ variant: "secondary" })}><KeyRound aria-hidden />Manage access</Link><InviteStaffForm /></>} />
