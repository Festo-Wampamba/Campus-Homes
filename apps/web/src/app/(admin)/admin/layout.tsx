...
const NAV: (AppNavItem & { any: string[] })[] = [
  ...
  { label: "Room change reviews", href: "/admin/room-changes", icon: <DoorOpen aria-hidden className={ICON_SIZE} />, group: "Operations", any: ["properties.approve", "properties.update", "properties.read"] },
  ...
  { label: "Student inquiries", href: "/admin/inquiries", icon: <LifeBuoy aria-hidden className={ICON_SIZE} />, group: "Operations", any: ["inquiries.resolve", "inquiries.read"] },
